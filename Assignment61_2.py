# Loan Approval/Rejection Prediction using Feedforward Neural Network
...
# [Application Income,Credit score,Loan amount,Existing EMI,Employment status]
...
# ------------------------------------------------------------
# Step 8: Predict New_Applicant
# ------------------------------------------------------------
New_Applicant = [[55000,720,400000,10000,1]]
New_Customer_scaled = scaler.transform(New_Applicant)
